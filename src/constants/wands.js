import aceOfWands from "../assets/wands/W01.jpg";
import twoOfWands from "../assets/wands/W02.jpg";
import threeOfWands from "../assets/wands/W03.jpg";
import fourOfWands from "../assets/wands/W04.jpg";
import fiveOfWands from "../assets/wands/W05.jpg";
import sixOfWands from "../assets/wands/W06.jpg";
import sevenOfWands from "../assets/wands/W07.jpg";
import eightOfWands from "../assets/wands/W08.jpg";
...
const wands = [
  {
    code: 1,
    card: "Ace of Wands",
    link: "https://youtu.be/AUNyhGQEjO0",
    img: aceOfWands,
    description: {
      upright:
  ...
  },
  {
    code: 3,
    card: "Three of Wands",
    link: "https://youtu.be/LSFGUoHCI9E",
    img: threeOfWands,
    description: {
      upright:
  ...
  },
  {
    code: 4,
    card: "Four of Wands",
    link: "https://youtu.be/x9I_K3CI-h0",
    img: fourOfWands,
    description: {
      upright:
  ...
  },
  {
    code: 5,
    card: "Five of Wands",
    link: "https://youtu.be/C5GPxObl9Is",
    img: fiveOfWands,
    description: {
      upright:
  ...
  },
  {
    code: 6,
    card: "Six of Wands",
    link: "https://youtu.be/GDgRXmxAV9A",
    img: sixOfWands,
    description: {
      upright:
  ...
  },
  {
    code: 7,
    card: "Seven of Wands",
    link: "https://youtu.be/tc6_U14n9E0",
    img: sevenOfWands,
    description: {
      upright:
  ...
  },
  {
    code: 8,
    card: "Eight of Wands",
    link: "https://youtu.be/prBrw4KnDyA",
    img: eightOfWands,
    description: {
      upright:
  ...
  },
  {
    code: 9,
    card: "Nine of Wands",
    link: "https://youtu.be/g77O5X5hPzo",
    img: nineOfWands,
    description: {
      upright:
  ...
  },
  {
    code: 10,
    card: "Ten of Wands",
    link: "https://youtu.be/iKGpoT6ZT1o",
    img: tenOfWands,
    description: {
      upright:
      ...
      reversed:
        "Lack of perspective on your life may impair your progress. The Ten of Wands reversed suggests that you are struggling to get a sense of perspective on the situation. A lack of objectivity may impair your ability to follow through and bring things to closure.      Try to rest yourself. Then step back to take another look at the big picture. If you feel too exhausted to work toward long-term goals, rest until your vision clears and you remember why it's worth the effort. Clear perspective leads to stronger motivation.",
    },
  },
  {
    code: 11,
    card: "Page of Wands",
    link: "https://youtu.be/T41o2G9zsI4",
    img: pageOfWands,
    description: {
      upright:
  ...
  },
  {
    code: 13,
    card: "Queen of Wands",
    link: "https://youtu.be/7HT1rkRGjlE",
    img: queenOfWands,
    description: {
      upright:
